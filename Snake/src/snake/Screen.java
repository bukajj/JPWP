package snake;import java.awt.EventQueue;
...
public class Screen extends JPanel implements Runnable, KeyListener {
    ...
    private Thread thread; //wątek
    private boolean running = false; //flaga uruchomienia
    private BodyPart b; //część węża
    private ArrayList<BodyPart> snake; //wąż
    private Apple apple; //jabłko
    private ArrayList<Apple> apples; //jabłka
    private Random r;
    private int xCoor = 10, yCoor = 10; //początkowe położenie
    private int size = 5; //początkowy rozmiar
    private int snakeSpeed = 250000 * 4; //prędkość węża
    // początkowy kierunek ruchu
    ...
    public void tick() {
        ...
        //sprawdzenie czy wąż wszedł w ścianę
        ...
        ticks++;
        //po wykonaniu tej metody wiecej razy niż wartosc snakeSpeed
        if(ticks > snakeSpeed) {
            ...
            ticks = 0;
            //dodawanie elementu węża dla nowych wspolrzednych
            b = new BodyPart(xCoor, yCoor, 10);
            snake.add(b);
            //sprawdzenie czy wąż jest większy od wartości size
