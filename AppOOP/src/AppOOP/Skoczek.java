...
public class Skoczek extends Sportowiec{
    ...
    public Skoczek(String imie, String nazwisko, String sukces,String[] jezyki, int obserwujacy){
        super(imie, nazwisko, sukces, jezyki, obserwujacy);
    }

    public Skoczek(String imie, String nazwisko, String sukces, int obserwujacy){
